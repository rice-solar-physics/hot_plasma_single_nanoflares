...
where $F_c$ is the Spitzer-H{\"a}rm heat flux. Smaller values of $f$ limit the heat flux to a greater degree. The main aspect of inclusion of a free-streaming limit is to slow down conductive cooling. We do not consider here other conduction models \citep[e.g. the non-local model discussed in the coronal context by][]{karpen_nonlocal_1987,ciaravella_non-local_1991,west_lifetime_2008} since they lead to similar generic results. 
	...
	\begin{figure*}
		...
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f1a}.eps}
			\label{fig:sf_T_panel1}}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f1b}.eps}
			\label{fig:sf_n_panel2}}
		\end{minipage}
		%
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f1c}.eps}
...
%
	...
	\begin{figure*}
		...
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f3a}.eps}
			\label{fig:tfe_T_panel1}}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f3b}.eps}
			\label{fig:tfe_n_panel2}}
		\end{minipage}
		%
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f3c}.eps}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.5\columnwidth]{{f4}.eps}
	...
	\begin{figure*}
		...
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f5a}.eps}
		...
		\begin{minipage}{0.49\textwidth}
			\subfigure{%
			\includegraphics[width=\columnwidth]{{f5c}.eps}
...
%%
	...
	\begin{figure}[t]
		\centering
		\includegraphics[width=0.5\columnwidth]{{f8}.eps}
