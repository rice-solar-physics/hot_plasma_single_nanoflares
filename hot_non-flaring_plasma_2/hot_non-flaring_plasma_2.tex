...
\begin{document}
	...
	%
	\par\hl{section on item three}
	%
	\par\hl{section on item four}
	%
	\section{Conclusions}
	\label{sec:conclusions}
	\par\hl{concluding remarks}
	\par\hl{Say something here about non-eq. ionization steepening slopes and lack of availability of observations; maybe could move some stuff from intro to here...}
	%
