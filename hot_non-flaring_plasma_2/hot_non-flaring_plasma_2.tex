...
\begin{document}
	...
	%
	\hl{Briefly describe in words the main results of the plots; say what the data is}
	%
	\begin{figure*}
		\centering
		\begin{minipage}[c]{0.49\textwidth}
